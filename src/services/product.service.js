...
class ProductFactory {
    ...
    static async createProduct(type, payload) {
        // Xác thực dữ liệu trước khi tạo sản phẩm
    ...
    static validateProductData(type, payload) {
        ...
        if (!payload.product_name || !payload.product_price || !payload.product_quantity || !payload.product_thumb) {
        ...
        switch(type) {
            case 'Electronic':
                if (!payload.product_attributes.manufacturer) {
                    throw new NotFoundError('Thiếu thông tin nhà sản xuất cho sản phẩm điện tử')
                }
                break
            ...
            case 'Furniture':
                if (!payload.product_attributes.brand || !payload.product_attributes.material) {
                    throw new NotFoundError('Thiếu thông tin thương hiệu hoặc chất liệu cho nội thất')
                }
                break
